...
public class GuiTheme {
    ...
    public static Value<Color> borderEnd = builder("Border End", Color.BLUE()).name("End").visible(b -> borderStart.isVisible()).build();
    ...
    public static Value<Color> primaryStart = builder("Primary Start", Color.RED()).name("Start").visible(b -> primaryMode.getValue().equals(Mode.H_GRADIENT) || primaryMode.getValue().equals(Mode.V_GRADIENT)).build();
    public static Value<Color> primaryEnd = builder("Primary End", Color.BLUE()).name("End").visible(b -> primaryStart.isVisible()).build();
    ...
    public static Value<Color> secondaryStart = builder("Secondary Start", Color.RED()).name("Start").visible(b -> secondaryMode.getValue().equals(Mode.H_GRADIENT) || secondaryMode.getValue().equals(Mode.V_GRADIENT)).build();
    public static Value<Color> secondaryEnd = builder("Secondary End", Color.BLUE()).name("End").visible(b -> secondaryStart.isVisible()).build();
    ...
    public static Value<Color> tertiaryStart = builder("Tertiary Start", Color.RED()).name("Start").visible(b -> tertiaryMode.getValue().equals(Mode.H_GRADIENT) || tertiaryMode.getValue().equals(Mode.V_GRADIENT)).build();
    public static Value<Color> tertiaryEnd = builder("Tertiary End", Color.BLUE()).name("End").visible(b -> tertiaryStart.isVisible()).build();
